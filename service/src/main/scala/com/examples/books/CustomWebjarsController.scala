...
// Is taken from swagger-finatra
object CustomWebjarsController {
  private val DEFAULT_EXPIRE_TIME_MS: Long = 86400000L // 1 day
}


class CustomWebjarsController @Inject()(resolver: FileResolver) extends Controller {
  import CustomWebjarsController.DEFAULT_EXPIRE_TIME_MS
